...
{
	{
		...
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbssm/basefire.tga" }, mipmap = true, }, },
			Idle = Normal,
		},
	},
	{
		...
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbssm/headfire.tga" }, mipmap = true, }, },
			Idle = Normal,
		},
	},
	{
		Name = "sbssmfire-barrel",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbssm/barrelfire.tga" }, mipmap = true, }, },
			Idle = Normal,
			Normal_christmas = { Frames = { { texture = path .. "/seasonal/xmas/sbssmbarrelfire.tga" }, mipmap = true, }, EventTag = "_christmas"},
			NormalAsia_christmas = { Frames = { { texture = path .. "/seasonal/xmas/sbssmbarrelfire.tga" }, mipmap = true, }, EventTag = "_christmas"},
			NormalBPO_christmas = { Frames = { { texture = path .. "/seasonal/xmas/sbssmbarrelfire.tga" }, mipmap = true, }, EventTag = "_christmas"},
			NormalRussia_christmas = { Frames = { { texture = path .. "/seasonal/xmas/sbssmbarrelfire.tga" }, mipmap = true, }, EventTag = "_christmas"},
			NormalCF_christmas = { Frames = { { texture = path .. "/seasonal/xmas/sbssmbarrelfire.tga" }, mipmap = true, }, EventTag = "_christmas"},
		},
	},
	{
		Name = "sbssmfire-reload",
		States =
		{
