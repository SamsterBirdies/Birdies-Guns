...
Sprites =
{
	...
	{
		Name = "sbshotcopter-wing",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbhelicopter/shotwing.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
				{
					...
					{ texture = path .. "/weapons/sbhelicopter/shotwing.png", duration = 6  },
					mipmap = true,
					duration = 0.2,
				},
				NextState = "Normal",
