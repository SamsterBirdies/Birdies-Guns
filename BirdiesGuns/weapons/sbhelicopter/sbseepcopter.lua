...
Sprites =
{
	...
	{
		Name = "sbseepcopter-wing",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbhelicopter/seepwing.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
				{
					...
					{ texture = path .. "/weapons/sbhelicopter/seepwing.png", duration = 6 },
					mipmap = true,
					duration = 0.2,
				},
				NextState = "Normal",
