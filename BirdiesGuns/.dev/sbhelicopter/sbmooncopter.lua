...
Sprites =
{
		...
		States =
		{
			...
			Reload =
			{
				Frames =
				{
					...
					{ texture = path .. "/weapons/sbhelicopter/heli.png", colour = { 0.7, 0.8, 1.0, 1.0 }, duration = 21  },
					mipmap = true,
					duration = 0.2,
				},
				NextState = "Normal",
	...
	{
		Name = "sbmooncopter-wing",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbhelicopter/moonwing.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
				{
					...
					{ texture = path .. "/weapons/sbhelicopter/moonwing.png", duration = 6 },
					mipmap = true,
					duration = 0.2,
				},
				NextState = "Normal",
