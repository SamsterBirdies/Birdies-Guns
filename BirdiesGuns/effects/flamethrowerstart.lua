...
SoundEvent = "mods/sbBGsoundbank/effects/flamethrowerstart"
Effects =
{
	--[[{
		Type = "sound",
		...
		Sound = path .. "/effects/media/flamethrower.ogg",
		Volume = 0.54,
		Priority = 192,
		Repeat = false,
	...
	},]]
	{
		...
		BurstPeriod = 0.1,
		SparksPerBurst = 1,
		LocalPosition = { x = 0, y = -50, z = 0 },	-- how to place the origin relative to effect position and direction (0, 0) 
		Sprite = "effects/media/CloudLarge.tga",

		Gravity = -260,						-- gravity applied to particle (981 is earth equivalent)
		...
		{
			{
				...
				SpeedMean = 750,				-- mean speed of sparks at emission (normal distribution)
