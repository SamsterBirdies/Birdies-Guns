...
Sprites =
{
	...
	{
		Name = "sbshockcopter-wing",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbhelicopter/shockwing.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
				{
					...
					{ texture = path .. "/weapons/sbhelicopter/shockwing.png", duration = 6  },
					mipmap = true,
					duration = 0.2,
				},
				NextState = "Normal",
