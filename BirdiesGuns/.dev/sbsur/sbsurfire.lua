...
Sprites =
{
	...
	{
		Name = "sbsurfire-reload",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbsur/projectilefire.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
	...
	{
		Name = "sbsurfire-reload-xmas",
		States =
		{
			Normal = { Frames = { { texture = path .. "/seasonal/xmas/gift_orange.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
	...
	{
		Name = "sbsurfire-reload-armoured",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbsur/armorprojectilefire.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
