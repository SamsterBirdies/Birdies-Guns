...
{
	{
		Name = "sbslingshotg-reload",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbslingshot/pullgrenade.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
