...
Sprites =
{
	...
	{
		Name = "sbwarthogcopter-heli",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbhelicopter/heliwarthog.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
	...
	{
		Name = "sbwarthogcopter-wing",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbhelicopter/warthogwing.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
				{
					...
					{ texture =  path .. "/weapons/sbhelicopter/warthogwing.png", duration = 6  },
					mipmap = true,
					duration = 0.2,
				},
				NextState = "Normal",
