...
Sprites =
{
	...
	{
		Name = "sbsuremp-reload",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbsur/projectileemp.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
	...
	{
		Name = "sbsuremp-reload-xmas",
		States =
		{
			Normal = { Frames = { { texture = path .. "/seasonal/xmas/gift_blue.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
	...
	{
		Name = "sbsuremp-reload-armoured",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbsur/armorprojectileemp.png" }, mipmap = true, }, },
			Idle = Normal,
			Reload =
			{
				Frames =
