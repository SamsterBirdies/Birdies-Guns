...
Effects =
{
	...
	{
		Type = "sprite",
		TimeToTrigger = SHOCK_START,
		LocalPosition = SHOCK_POS,
		LocalVelocity = { x = 0, y = 0, z = 0 },
		Acceleration = { x = 0, y = 0, z = 0 },
		Drag = 0,
		Sprite = path .. "/weapons/sbrailgun/shock2.png",
		Additive = true,
		TimeToLive = 0.04,
		InitialSize = 1.146875,
		ExpansionRate = 0,
		Angle = -90,
		AngularVelocity = 0,
		RandomAngularVelocityMagnitude = 0,
	...
	{
		Type = "sprite",
		TimeToTrigger = SHOCK_START + SHOCK_PERIOD + 0.04,
		LocalPosition = SHOCK_POS,
		LocalVelocity = { x = 0, y = 0, z = 0 },
		Acceleration = { x = 0, y = 0, z = 0 },
		Drag = 0,
		Sprite = path .. "/weapons/sbrailgun/shock1.png",
		Additive = true,
		TimeToLive = 0.04,
		InitialSize = 1.146875,
		ExpansionRate = 0,
	...
	{
		Type = "sprite",
		TimeToTrigger = SHOCK_START + SHOCK_PERIOD * 2,
		LocalPosition = SHOCK_POS,
		LocalVelocity = { x = 0, y = 0, z = 0 },
		Acceleration = { x = 0, y = 0, z = 0 },
		Drag = 0,
...
SoundEvent = "mods/sbBGsoundbank/effects/railgun_fire"
