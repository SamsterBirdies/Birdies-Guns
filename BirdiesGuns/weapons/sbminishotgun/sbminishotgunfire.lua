...
FireEffect = path .. "/effects/fire_sbminishotgunflame.lua"
...
Sprites =
{
	...
	{
		Name = "sbminishotgunfire-head",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/sbminishotgun/headfire.tga" }, mipmap = true, }, },
			Idle = Normal,
		},
	},
