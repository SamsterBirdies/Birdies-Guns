...
{
	{
		Name = "sbtriplemortar-base",
		States =
		{
			Normal = { Frames = { { texture = "weapons/mortar/base.tga" }, mipmap = true, }, },
			Idle = Normal,
		},
	},
	{
		Name = "sbtriplemortar-head",
		States =
		{
